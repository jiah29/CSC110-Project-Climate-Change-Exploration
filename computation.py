...
def find_emission_average(countries_list: Dict[str, Country]) -> Dict[str, List[float]]:
    ...
    >>> find_emission_average(countries_lst) == {'Agriculture Emission': [8.09, 8.41,\
                                                ...
                                                12.05, 11.79, 12.08, 12.05, 12.12, \
                                                13.45, 13.86, 15.85, 15.91, 15.78, 15.73,\
                                                16.22, 15.15, 15.35], \
                                                'Manufacturing Emission': [2.1, 1.4, 0.8, 0.5,\
                                                0.5, 0.5, 0.5, 0.2, 0.4, 0.5, 0.5, 0.5, 0.4, \
                                                0.5, 0.5, 0.4, 0.7, 0.6, 0.5, 0.8, 1.0, 1.1,\
                                                0.6, 0.6, 0.9, 0.7, 0.6], \
                                                'Industry Emission': [0.05, 0.05, 0.06, 0.06,\
                                                0.07, 0.07, 0.08, 0.1, 0.11, 0.12, 0.11, 0.12,\
                                                0.12, 0.14, 0.14, 0.14, 0.16, 0.18, 0.2, 0.22,\
                                                0.25, 0.31, 0.38, 0.45, 0.53, 0.59, 0.74]}
    True
...
def find_average_revenue(countries_list: Dict[str, Country]) -> Dict[str, List[float]]:
    ...
    >>> sample['Agriculture Revenue'] == [457411497.0, 419369381.6, 324233493.7, 331783780.7,\
                                 ...
                                 643125666.465, 1227306585.0, 1402783044.0, 1299101612.0, \
                                 1367254712.0, 1533180073.0, 1375053978.0, 1425873036.0]
    True
    """
