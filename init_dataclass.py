...
class Country:
    ...
    >>> sample_revenue = Revenue(country_code='ABW', \
                                 industry_value=['', '', '', '', '', '', \
                                 '', 262463687.2, 291620111.7, 267882681.6, \
                                 296480446.9, 305515642.5, 296703352.0, 339418994.4, \
                                 392163687.2, 431287150.8, 474557541.9, 496345810.1, \
                                 495007262.6, 404204469.3, '', '', '', '', '', '', ''], \
                                 manufacture_value=['', '', '', '', '', 33251396.65, \
                                 ...
                                 8727932.961, 9012290.503, 9546927.374, 10597206.7, \
                                 10451955.31, 11005027.93, '', '', '', '', '', '', ''])
    >>> sample_country = Country('SAM', 'Lower middle income', 'Sample', None, sample_revenue)
    >>> sample_country.sector_revenues.industry_value == ['', '', '', '', '', '', '', \
                                                         262463687.2, 291620111.7, \
                                                         267882681.6, 296480446.9, \
                                                         305515642.5, 296703352.0, \
                                                         339418994.4, 392163687.2, \
                                                         431287150.8, 474557541.9, \
                                                         496345810.1, 495007262.6, \
                                                         404204469.3, '', '', '', '',\
                                                          '', '', '']
    True
    """
