...
if __name__ == '__main__':
    ...
    #  Find the average emission value of each sector for each income group.
    ...
    #  Find the average revenue of each sector for each income group.
    ...
    #  Create dataframe objects for each income group
